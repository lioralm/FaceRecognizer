...
if __name__ == '__main__':
    ...
    # then send 10 get request

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[6,9,6]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[1,3,4]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[1,2,3]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[1,7,7]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[9,9,9]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[8,1,4]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[8,7,6]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[3,5,1]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[2,2,2]")
    print(resp.data.decode('utf-8'))

    resp = http.request('GET', "http://127.0.0.1:5000/persons?features=[6,8,3]")
    print(resp.data.decode('utf-8'))
